...
fs::dir_create("exercicios/exercicios_resolucao/xaringan")

# 2. Crie também as pastas para adicionar as imagens,
#  as bibliotecas e arquivos de folhas de estilo (css):

fs::dir_create("exercicios/exercicios_resolucao/xaringan/img")

fs::dir_create("exercicios/exercicios_resolucao/xaringan/libs")

fs::dir_create("exercicios/exercicios_resolucao/xaringan/css")
